...
export class ProductsComponent implements OnInit {
  ...
  @Input() set filteredProducts(value: string) {
    this.filteredProduct = this.filterService(value);
  }
  ...
  filterService(catId: string) {
    if (catId === 'all') {
      return this.products;
    } else {
      return this._ProductsService.getproductByCategory(catId);
    }
  }
